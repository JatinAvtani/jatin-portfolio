          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 justify-center">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-medium mr-14"> Email</h4>
                  <a
                    href="mailto:jatinavtani345@gmail.com"
                    className="text-muted-foreground hover:text-primary transition-colors ml-5"
                  >
                    jatinavtani345@gmail.com
                  </a>
                </div>
              </div>
              <div className="flex items-start space-x-4">
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4 justify-center">
                <a href="https://www.linkedin.com/in/jatin-avtani" target="_blank">
                  <Linkedin />
                </a>
                
                <a href="https://www.instagram.com/ix_jatin" target="_blank">
                  <Instagram />
                </a>
